...
#noise range to use
noiseinc = 0.02 #noise increments
...
savedatafolder = 'data_from_full_eval_mnist12_comparesigmas/' #to save all data from the next loop
